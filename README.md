...
Overall, AbdomenAtlas 3.0 presents per-voxel segmentation masks for **tumors in the kidney, pancreas, and liver**, masks for several **blood vessels**, including the aorta, IVC, SMA, CHA, CA, and SA, and **9 organs**, including the liver, kidney, pancreas, spleen, adrenal glands, stomach, duodenum, bile duct, intestines.
